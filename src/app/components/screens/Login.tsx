      ...
      <div className="flex-1 overflow-auto px-6 py-8">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            type="submit"
            className="w-full bg-gradient-to-r from-primary to-secondary text-white py-4 rounded-2xl font-medium text-lg shadow-lg shadow-primary/30 mt-8"
          >
            Sign In
          </motion.button>
        </form>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            <button className="flex items-center justify-center gap-2 py-3 border border-border rounded-2xl hover:bg-muted/50 transition-colors">
